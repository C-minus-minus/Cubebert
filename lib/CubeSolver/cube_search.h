...
public:
    /**
     * Constructor
     * @param tableManager - The table manager that contains the move tables and pruning tables
     */
    CubeSearch(TableManager* tableManager);
     ...
     */
    std::string getPhase1Solution(StickerCube* scrambledCube);
     ...
     */
    std::string getPhase2Solution(StickerCube* scrambledCube);
     ...
     * @return - Algorithm to solve phase 2 of the cube
     */
    std::string getPhase2SolutionE(StickerCube* scrambledCube);
     ...
     * @return - Algorithm to solve phase 2 of the cube
     */
    std::string getPhase2SolutionF(StickerCube* scrambledCube);
...
private:
     ...
     * @return - If it exists at this depth, this will return the algorithm to solve phase 2, returns an empty string otherwise
     */
    static bool phase2IterativeDeepeningAStarF(TableManager *instance, int edgeCoord, int cornerCoord, int sliceCoord, int side1Coord, int side2Coord, int goalDepth, int currDepth, std::vector<std::string>* solution);
};
